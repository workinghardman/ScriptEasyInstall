...
ADD_SWAP=N
GITHUB_DL=https://github.com/crowdcoinChain/Crowdcoin/releases/download/1.1.0/Crowdcoin_command_line_binaries_linux_2.0.0.tar.gz
RPCPORT=11998
CRCPORT=12875
...
wget $GITHUB_DL
tar -zxvf ./Crowdcoin_command_line_binaries_linux_2.0.0.tar.gz
...
(crontab -l 2>/dev/null; echo "* * * * * cd ~/ScriptEasyInstall &  bash check_status.sh 2>&1 >> mn-check-cron.log") | crontab -
